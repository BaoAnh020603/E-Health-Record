...
> 🇬🇧 English original: [`TODO.md`](TODO.md). **Englisch ist die kanonische Quelle** — bei Abweichung gewinnt das englische Original.

# TODO-Roadmap — Backlog & Aufgabenverfolgung

Persistentes, priorisiertes Backlog. Diese Datei ist das zentrale Status-Board für **Aufgaben, Streams und deren Beziehungen** — was geplant, in Arbeit und erledigt ist. Jeder offene Eintrag wird **als eigener Commit** verarbeitet; die Spalte `Commit` wird mit Hash und Datum befüllt, sobald ein Eintrag `DONE` ist.

> **Was hierher gehört und was nicht.** Diese Roadmap enthält **nur Aufgaben-/Stream-Daten**. Projektkontext-Dokumente, die nicht an eine konkrete Aufgabe oder einen Stream gebunden sind, leben als separate Dateien und werden von hier verlinkt:
>
> - **Endpoint-Inventar** → [`docs/API/endpoint-inventory.md`](docs/API/endpoint-inventory.md)
> - **Whitelist-SSoT-Audit (2026-05-28)** → [`docs/findings/audit-findings-2026-05-28.md`](docs/findings/audit-findings-2026-05-28.md)
> - **Whole-Repo-Architektur-Audit (2026-05-30)** → [`docs/findings/ARCH_REVIEW_WHOLE_REPO.md`](docs/findings/ARCH_REVIEW_WHOLE_REPO.md)
> - Architekturentscheidungen → [`docs/decisions.md`](docs/decisions.md) · Session-Log → [`docs/journal.md`](docs/journal.md) · How-tos → [`docs/howto/`](docs/howto/)

> **Generierte Datei.** `TODO.md` / `TODO_de.md` werden aus den Per-Task-Dateien (`tasks/TODO-NNN.md`) und den Stream-/Include-Quellen unter [`streams/`](streams/) generiert. **Niemals das Dashboard von Hand editieren** — die Quellen ändern und `make roadmap` ausführen (Roadmap-as-data, ADR-018; siehe das [How-to](docs/howto/howto-track-and-claim-tasks.md)).

> **Leseanleitung:** Beginne mit der [Stream-Zusammenfassung](#stream-zusammenfassung) für das große Bild, öffne dann die Per-Task-Datei unter [`tasks/`](tasks/) für Reference / Acceptance Criteria / Notes je TODO.

**Status-Legende:** 🔴 OPEN · 🟡 IN PROGRESS · 🟢 DONE · ⚪ DEFERRED / OBSOLETE

**Prioritäts-Legende:** 🔥 P9-P7 (hoch, dringend) · 📌 P6-P4 (mittel, normal) · 🌿 P3-P1 (niedrig, nice-to-have) · ⚪ (erledigt / zurückgestellt — N/A)

**Abhängigkeitsnotation:** `→ TODO-X` = hart (X muss zuerst fertig sein) · `~ TODO-X` = weich (Arbeit nach X leichter, aber stubbar) · `—` = keine

## 🔥 Offene Streams - nach Priorität

| Stream | Owner | Top-Prio | Notion | Epic | Offen (🟡 WIP) | Done | Prio-Profil |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
> `*` nach einem Owner = aus dem neuesten Task-Claim abgeleitet (der Stream hat keinen expliziten Owner).
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **[W01](TODO_archive_de.md#w01---stop-the-writes)** | nhatminhtrieu* | — | — | Stop the writes | 🟢 Geschlossen | 4/4 | — |
| **[W02](TODO_archive_de.md#w02---restore-truth-in-db)** | nhatminhtrieu* | — | — | Restore truth in DB | 🟢 Geschlossen | 2/2 | — |
| **[W03](TODO_archive_de.md#w03---clean-up-reads)** | huan* | — | — | Clean up reads | 🟢 Geschlossen | 4/4 | — |
| **[W04](#w04---special-cases--db)** | caphefalumi-831* | 🌿 P2 | — | Special cases → DB | 🔴 Offen | 3/4 | 1×P2 |
| **[W05](TODO_archive_de.md#w05---prevention)** | lpc-001* | — | — | Prevention | 🟢 Geschlossen | 10/10 | — |
| **[W06](TODO_archive_de.md#w06---logging-guard)** | lpc-002* | — | — | Logging guard | 🟢 Geschlossen | 1/1 | — |
| **[W07](#w07---security-blockers--hardening)** | nhatminhtrieu* | 📌 P6 | — | Security blockers & hardening | 🔴 Offen | 13/16 | 1×P6 · 1×P2 · 1×P1 |
| **[W08](#w08---reliability--data-integrity)** | Toan | 🌿 P2 | [epic](https://www.notion.so/3736ab7a19168122a53dd0e821b4ab57) | Reliability & data integrity | 🔴 Offen | 9/10 | 1×P2 |
| **[W09](TODO_archive_de.md#w09---performance)** | thuan-427* | — | — | Performance | 🟢 Geschlossen | 6/6 | — |
| **[W10](#w10---architecture--data-layer-consolidation)** | lpc-000* | 🌿 P2 | — | Architecture & data-layer consolidation | 🔴 Offen | 30/31 | 1×P2 |
| **[W11](#w11---documentation-accuracy)** | lpc-000* | 🌿 P2 | — | Documentation accuracy | 🔴 Offen | 4/5 | 1×P2 |
| **[W12](TODO_archive_de.md#w12---classification-correctness--doc-drift)** | violetchan-2509* | — | — | Classification correctness & doc-drift | 🟢 Geschlossen | 12/12 | — |
| **[W13](#w13---sales-availability-re-architecture-orbit-owned-sync-into-supabase-orbit-schema)** | Hung | 📌 P5 | [epic](https://www.notion.so/3726ab7a191681e3a4d2fdf5c20da763) | Sales-availability re-architecture: Orbit-owned sync into Supabase `orbit` schema | 🔴 Offen | 6/8 | 2×P5 |
| **[W14](#w14---performance-dashboard-auditability--trust)** | Minh | 📌 P4 | [epic](https://www.notion.so/3726ab7a1916812d8f26d90fd9c09894) | Performance-dashboard auditability & trust | 🔴 Offen | 16/18 | 1×P4 · 1×P3 |
| **[W15](TODO_archive_de.md#w15---performance-dashboard-endpoint-coverage--all-tabs)** | Huan | — | [epic](https://www.notion.so/3736ab7a191681af99d2cab9bd4cd9b7) | Performance-dashboard endpoint coverage — all tabs | 🟢 Geschlossen | 18/18 | — |
| **[W16](TODO_archive_de.md#w16---panterservice-lead-duplication-shutdown--orbit_greenleads-dedup)** | Duc Anh | — | [epic](https://www.notion.so/3736ab7a1916812aa326fcba1d44861c) | PanterService lead-duplication shutdown & `orbit_green.leads` dedup | 🟢 Geschlossen | 8/8 | — |
| **[W17](TODO_archive_de.md#w17---closer-performance--schema-foundations-self-booking-lineage--structured-funnel)** | Hung | — | [epic](https://www.notion.so/3746ab7a191681e3a24ff09eedb90b4d) | Closer Performance · schema foundations (self-booking lineage + structured funnel) | 🟢 Geschlossen | 5/5 | — |
| **[W18](TODO_archive_de.md#w18---closer-performance--leaderboard-endpoint-full-funnel--revenue)** | hazhaz-447* | — | [epic](https://www.notion.so/3746ab7a191681e4aa2bc9e86256db1e) | Closer Performance · leaderboard endpoint (full funnel + revenue) | 🟢 Geschlossen | 3/3 | — |
| **[W19](TODO_archive_de.md#w19---closer-performance--capacity-endpoint-kapazität-sub-tab)** | Thuan | — | [epic](https://www.notion.so/3746ab7a19168114a095e39e148e4611) | Closer Performance · capacity endpoint (Kapazität sub-tab) | 🟢 Geschlossen | 3/3 | — |
| **[W20](TODO_archive_de.md#w20---closer-performance--tests--fe-contract)** | hazhaz-447* | — | [epic](https://www.notion.so/3746ab7a19168187ab82f3930d389330) | Closer Performance · tests & FE contract | 🟢 Geschlossen | 3/3 | — |
| **[W21](#w21---termine-prod--supabase-reconciliation)** | Minh | 📌 P6 | [epic](https://www.notion.so/3756ab7a191681988041d8ecc7618503) | Termine prod ↔ Supabase reconciliation | 🔴 Offen | 18/21 | 1×P6 · 1×P5 · 1×P3 |
| **[W22](TODO_archive_de.md#w22---salesperson-onboarding-readiness)** | hazhaz-672* | — | [epic](https://www.notion.so/3756ab7a1916817d8682d2b4d62591cc) | Salesperson onboarding readiness | 🟢 Geschlossen | 4/4 | — |
| **[W23](#w23---agent-memory-cross-project-read)** | lpc-000 | 🌿 P2 | — | Agent Memory (cross-project read) | 🔴 Offen | 4/5 | 1×P2 |
| **[W24](TODO_archive_de.md#w24---sql-injection-hardening)** | Huan | — | [epic](https://www.notion.so/3766ab7a191681c9b765d9fb2c072608) | SQL Injection Hardening | 🟢 Geschlossen | 4/4 | — |
| **[W25](TODO_archive_de.md#w25---customer-visit-duplication-detection--calendar-blocker-cleanup)** | Minh | — | [epic](https://www.notion.so/3766ab7a19168157a1befcae0f2a9c58) | Customer-visit duplication detection & calendar-blocker cleanup | 🟢 Geschlossen | 5/5 | — |
| **[W26](TODO_archive_de.md#w26---recommendation-engine-window-anchoring-strategy-travel-time-vs-appointment)** | caphefalumi | — | [epic](https://www.notion.so/3766ab7a19168175ae03d93436beb563) | Recommendation-engine window-anchoring strategy (travel-time vs. appointment) | 🟢 Geschlossen | 6/6 | — |
| **[W27](#w27---general-bugfix)** | nhatminhtrieu* | 📌 P5 | [epic](https://www.notion.so/3766ab7a19168114b473d00670af22c0) | General bugfix | 🔴 Offen | 7/9 | 2×P5 |
| **[W28](TODO_archive_de.md#w28---issue-tracking-v2-roadmap-as-data)** | lpc-000 | — | — | Issue-tracking v2 (roadmap-as-data) | 🟢 Geschlossen | 10/10 | — |
| **[W29](#w29---telli-x-orbit-terminbuchung--6-ai-voice-appointment-tools-on-the-live-orbit-public-api)** | nhatminhtrieu* | 🌿 P2 | [epic](https://app.notion.com/p/3776ab7a1916814596f2cc04a213cffe) | Telli x Orbit Terminbuchung — 6 AI-voice appointment tools on the live Orbit public API | 🔴 Offen | 15/17 | 1×P2 · 1×P1 |
| **[W30](TODO_archive_de.md#w30---adopt-the-asol-issue-tracking-package)** | lpc-000 | — | — | Adopt the asol-issue-tracking package | 🟢 Geschlossen | 5/5 | — |
| **[W31](#w31---transactional-email-pipeline-postmark-in-orbit-be)** | thuan-742* | 📌 P6 | [epic](https://app.notion.com/p/3796ab7a191681889b6ae0412590e272) | Transactional email pipeline (Postmark) in orbit-be | 🔴 Offen | 10/11 | 1×P6 |
| **[W32](TODO_archive_de.md#w32---recurring-appointments--series-deletion)** | dev-hieu* | — | — | Recurring appointments & series deletion | 🟢 Geschlossen | 2/2 | — |
| **[W33](TODO_archive_de.md#w33---route-optimization--regional-clustering)** | hazhaz-308* | — | — | Route optimization & regional clustering | 🟢 Geschlossen | 2/2 | — |
| **[W34](#w34---google-workspace-sync-integrity--endpoint-consolidation)** | lpc-000* | 📌 P5 | — | Google Workspace sync integrity & endpoint consolidation | 🔴 Offen | 5/7 | 2×P5 |
| **[W35](#w35---supabase-orbit-v2-schema-rbac--onboarding-defaults)** | lpc-000* | 🔥 P7 | — | Supabase Orbit V2 schema, RBAC & onboarding defaults | 🔴 Offen | 1/3 | 1×P7 · 1×P5 |
| **[W36](TODO_archive_de.md#w36---dashboard--simulation-live-data-backend)** | nhatminhtrieu* | — | — | Dashboard & simulation live data (backend) | 🟢 Geschlossen | 4/4 | — |
| **[W37](#w37---infrastructure-tooling--administrative-tasks)** | thuan-427* | 🔥 P7 | — | Infrastructure, tooling & administrative tasks | 🔴 Offen | 5/14 | 1×P7 · 2×P6 · 1×P5 · 2×P4 · 2×P3 · 1×P1 |
| **[W38](TODO_archive_de.md#w38---data-pipeline--supabase--orbit-sync-enrichment)** | antigravity* | — | — | Data pipeline — Supabase → Orbit sync enrichment | 🟢 Geschlossen | 1/1 | — |
| **[W39](#w39---orbit_green-schema-hardening-alpha-audit-2026-06-10)** | lpc-000* | 🌿 P3 | — | orbit_green schema hardening (alpha audit 2026-06-10) | 🔴 Offen | 5/7 | 1×P3 · 1×P2 |
| **[W40](#w40---supabase-public-schema-optimization-live-audit-2026-06-10)** | — | 🔥 P7 | — | Supabase public schema optimization (live audit 2026-06-10) | 🔴 Offen | 0/5 | 2×P7 · 1×P5 · 1×P4 · 1×P3 |
| **[W41](TODO_archive_de.md#w41---test-full-pipeline-unknownunclassified-bucket-regression-rca-2026-06-10)** | viley* | — | — | test-full-pipeline UNKNOWN/UNCLASSIFIED bucket regression (RCA 2026-06-10) | 🟢 Geschlossen | 7/7 | — |
| **[W42](TODO_archive_de.md#w42---decommission-the-legacy-bare-orbit-schema-green-only)** | antigravity-7598* | — | — | Decommission the legacy bare `orbit` schema (green-only) | 🟢 Geschlossen | 10/10 | — |
| **[W43](TODO_archive_de.md#w43---ci-staging--release-quality-gate-local--alpha--beta--prod)** | violetchan-2509* | — | — | CI staging & release quality gate (local → alpha → beta → prod) | 🟢 Geschlossen | 21/21 | — |
| **[W44](TODO_archive_de.md#w44---ai-doc-schema-endpoint-documentation--make-every-ai-docs-endpoint-self-describing-for-ai-agents)** | nhatminhtrieu* | — | — | AI-doc schema endpoint documentation — make every /ai-docs endpoint self-describing for AI agents | 🟢 Geschlossen | 11/11 | — |
| **[W45](TODO_archive_de.md#w45---provision-engine--correctness-security--completion-be-side-of-the-2026-06-12-befe-gap-report)** | caphefalumi-831* | — | — | Provision engine — correctness, security & completion (BE side of the 2026-06-12 BE↔FE gap report) | 🟢 Geschlossen | 30/30 | — |
| **[W46](TODO_archive_de.md#w46---ci-unit-test-performance--drive-the-unit-test-pipeline-stage-under-1-minute)** | caphefalumi-831* | — | — | CI unit-test performance — drive the unit-test pipeline stage under 1 minute | 🟢 Geschlossen | 4/4 | — |
| **[W47](TODO_archive_de.md#w47---interactive-appointment-actions-from-email-confirmcancelreschedule)** | lpc-003 | — | — | Interactive appointment actions from email (confirm/cancel/reschedule) | 🟢 Geschlossen | 5/5 | — |
| **[W48](TODO_archive_de.md#w48---self-hosted-gitlab-container-registry-for-ci-base-images)** | lpc-003 | — | — | Self-hosted GitLab Container Registry for CI base images | 🟢 Geschlossen | 12/12 | — |
| **[W49](#w49---publicinternal-proposals-parity--salesperson-working-hours-completeness-telli-0-proposals-rca)** | lpc-001 | 🌿 P3 | — | Public/internal proposals parity & salesperson working-hours completeness (Telli 0-proposals RCA) | 🔴 Offen | 5/6 | 1×P3 |
| **[W50](#w50---customer-feedback--field-reported-ux-gaps)** | dev_tien* | 📌 P5 | — | Customer feedback — field-reported UX gaps | 🔴 Offen | 1/2 | 1×P5 |
| **[W51](#w51---analysis-pass--gap-reports--track-jl-cc--asol-gap-analysis-findings-as-actionable-checklists-that-link-to-the-implementation-tasks)** | — | 📌 P5 | — | Analysis-pass & gap reports — track jl-cc / asol-gap-analysis findings as actionable checklists that link to the implementation tasks | 🔴 Offen | 0/2 | 2×P5 |
| **[W52](#w52---clean-and-consolidate-over-deletion-incident-18-jun--recover-jans-wrongly-deleted-appointments-fix-the-root-cause-over-deletion-and-prevent-recurrence)** | lpc-000* | 🔥 P7 | — | Clean-and-Consolidate over-deletion incident (18 Jun) — recover Jan's wrongly deleted appointments, fix the root-cause over-deletion, and prevent recurrence | 🔴 Offen | 10/14 | 1×P7 · 3×P1 |
| **[W53](#w53---termine-reconciliation)** | nhatminhtrieu* | 📌 P6 | — | Termine Reconciliation | 🔴 Offen | 10/13 | 1×P6 · 2×P5 |
| **[W54](#w54---clean--consolidate-refactor--net-first-correctness-then-structure-decomposition-of-the-4527-line-cleanup_service-god-flow)** | Hung | 📌 P6 | — | Clean & Consolidate refactor — net-first, correctness-then-structure decomposition of the 4527-line cleanup_service god-flow | 🔴 Offen | 4/9 | 1×P6 · 4×P4 |
| **[W55](TODO_archive_de.md#w55---telesales-customer-visits-must-be-place_typeonline--one-time-prod-backfill--a-re-runnable-maintenance-endpoint)** | Thuan | — | — | Telesales customer visits must be place_type=online — one-time prod backfill + a re-runnable maintenance endpoint | 🟢 Geschlossen | 2/2 | — |
| **[W56](TODO_archive_de.md#w56---classification-override-coverage--post-classification-overrides-must-apply-on-every-replica-host-rule-lambda-rule-v2-meta-classification-and-be-parity-tested)** | caphefalumi* | — | — | Classification override coverage — post-classification overrides must apply on every replica (host rule, lambda rule, V2 meta-classification) and be parity-tested | 🟢 Geschlossen | 4/4 | — |
| **[W57](#w57---consolidate-the-fragmented-booking-endpoints-behind-one-booking-service--populateexpose-event-attendees)** | cc-999* | 📌 P6 | — | Consolidate the fragmented booking endpoints behind one booking service + populate/expose event attendees | 🔴 Offen | 1/6 | 2×P6 · 3×P5 |
| **[W58](#w58---close-the-integration-test-coverage-gaps-on-the-critical-moneydatacorrectness-paths-real-pg-nets-where-mocked--false-green)** | codex* | 🔥 P8 | — | Close the integration-test coverage gaps on the critical money/data/correctness paths (real-PG nets where mocked = false green) | 🔴 Offen | 0/14 | 2×P8 · 1×P7 · 2×P6 · 5×P5 · 3×P4 · 1×P3 |

### Roadmap-Struktur & Claims
...
flowchart TD
    ...
    W54 ~~~ W57
    W57 ~~~ W58
    click W04 "streams/W04-special-cases-to-db_de.md"
    click W07 "streams/W07-security-hardening_de.md"
    click W08 "streams/W08-reliability_de.md"
    click W10 "streams/W10-architecture_de.md"
    click W11 "streams/W11-documentation_de.md"
    click W13 "streams/W13-sales-availability_de.md"
    click W14 "streams/W14-dashboard-trust_de.md"
    click W21 "streams/W21-termine-reconciliation_de.md"
    click W23 "streams/W23-agent-memory_de.md"
    click W27 "streams/W27-general-bugfix_de.md"
    click W29 "streams/W29-telli-terminbuchung_de.md"
    click W31 "streams/W31-transactional-email_de.md"
    click W34 "streams/W34-gworkspace-sync-integrity_de.md"
    click W35 "streams/W35-supabase-v2-rbac-onboarding_de.md"
    click W37 "streams/W37-infra-tooling-admin_de.md"
    click W39 "streams/W39-orbit-green-schema-hardening_de.md"
    click W40 "streams/W40-supabase-public-optimization_de.md"
    click W49 "streams/W49-proposals-working-hours-correctness_de.md"
    click W50 "streams/W50-customer-feedback_de.md"
    click W51 "streams/W51-analysis-pass-reports_de.md"
    click W52 "streams/W52-clean-consolidate-overdelete-incident_de.md"
    click W53 "streams/W53-termine-sync-annotation_de.md"
    click W54 "streams/W54-clean-consolidate-refactor_de.md"
    click W57 "streams/W57-booking-consolidation-attendees_de.md"
    click W58 "streams/W58-integration-test-hardening_de.md"
...
> Geschlossene Streams ins Archiv verschoben: [`TODO_archive_de.md`](TODO_archive_de.md) (33).

### W04 - Special cases → DB

[Stream-Datei](streams/W04-special-cases-to-db_de.md)

#### Status- & Abhängigkeitskarte
...
flowchart TD
    ...
    TODO_010 -.-> TODO_017
    TODO_011 -.-> TODO_409
    click TODO_010 "tasks/TODO-010_de.md"
    click TODO_011 "tasks/TODO-011_de.md"
    click TODO_017 "tasks/TODO-017_de.md"
    click TODO_409 "tasks/TODO-409_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W07-security-hardening_de.md)
...
flowchart TD
    ...
    TODO_070 --> TODO_186
    TODO_025 -.-> TODO_190
    click TODO_025 "tasks/TODO-025_de.md"
    click TODO_070 "tasks/TODO-070_de.md"
    click TODO_186 "tasks/TODO-186_de.md"
    click TODO_190 "tasks/TODO-190_de.md"
    click TODO_284 "tasks/TODO-284_de.md"
    click TODO_287 "tasks/TODO-287_de.md"
    click TODO_389 "tasks/TODO-389_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W08-reliability_de.md)
...
flowchart TD
    ...
    click TODO_405 "tasks/TODO-405_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W10-architecture_de.md)
...
flowchart TD
    ...
    TODO_410 -.-> TODO_414
    TODO_411 -.-> TODO_414
    click TODO_037 "tasks/TODO-037_de.md"
    click TODO_038 "tasks/TODO-038_de.md"
    click TODO_039 "tasks/TODO-039_de.md"
    click TODO_040 "tasks/TODO-040_de.md"
    click TODO_172 "tasks/TODO-172_de.md"
    click TODO_292 "tasks/TODO-292_de.md"
    click TODO_293 "tasks/TODO-293_de.md"
    click TODO_294 "tasks/TODO-294_de.md"
    click TODO_303 "tasks/TODO-303_de.md"
    click TODO_305 "tasks/TODO-305_de.md"
    click TODO_306 "tasks/TODO-306_de.md"
    click TODO_308 "tasks/TODO-308_de.md"
    click TODO_314 "tasks/TODO-314_de.md"
    click TODO_330 "tasks/TODO-330_de.md"
    click TODO_331 "tasks/TODO-331_de.md"
    click TODO_336 "tasks/TODO-336_de.md"
    click TODO_337 "tasks/TODO-337_de.md"
    click TODO_338 "tasks/TODO-338_de.md"
    click TODO_339 "tasks/TODO-339_de.md"
    click TODO_340 "tasks/TODO-340_de.md"
    click TODO_341 "tasks/TODO-341_de.md"
    click TODO_342 "tasks/TODO-342_de.md"
    click TODO_343 "tasks/TODO-343_de.md"
    click TODO_349 "tasks/TODO-349_de.md"
    click TODO_350 "tasks/TODO-350_de.md"
    click TODO_357 "tasks/TODO-357_de.md"
    click TODO_358 "tasks/TODO-358_de.md"
    click TODO_359 "tasks/TODO-359_de.md"
    click TODO_360 "tasks/TODO-360_de.md"
    click TODO_361 "tasks/TODO-361_de.md"
    click TODO_414 "tasks/TODO-414_de.md"
    click TODO_011 "tasks/TODO-011_de.md"
    click TODO_410 "tasks/TODO-410_de.md"
    click TODO_411 "tasks/TODO-411_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W11-documentation_de.md)
...
flowchart TD
    ...
    TODO_039 -.-> TODO_041
    click TODO_041 "tasks/TODO-041_de.md"
    click TODO_042 "tasks/TODO-042_de.md"
    click TODO_043 "tasks/TODO-043_de.md"
    click TODO_044 "tasks/TODO-044_de.md"
    click TODO_229 "tasks/TODO-229_de.md"
    click TODO_039 "tasks/TODO-039_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
...
[Stream-Datei](streams/W13-sales-availability_de.md)
...
flowchart TD
    ...
    TODO_053 --> TODO_056
    TODO_056 --> TODO_057
    click TODO_051 "tasks/TODO-051_de.md"
    click TODO_052 "tasks/TODO-052_de.md"
    click TODO_053 "tasks/TODO-053_de.md"
    click TODO_054 "tasks/TODO-054_de.md"
    click TODO_055 "tasks/TODO-055_de.md"
    click TODO_056 "tasks/TODO-056_de.md"
    click TODO_057 "tasks/TODO-057_de.md"
    click TODO_221 "tasks/TODO-221_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W14-dashboard-trust_de.md)
...
flowchart TD
    ...
    TODO_066 --> TODO_113
    TODO_408 --> TODO_421
    click TODO_058 "tasks/TODO-058_de.md"
    click TODO_059 "tasks/TODO-059_de.md"
    click TODO_060 "tasks/TODO-060_de.md"
    click TODO_061 "tasks/TODO-061_de.md"
    click TODO_062 "tasks/TODO-062_de.md"
    click TODO_063 "tasks/TODO-063_de.md"
    click TODO_064 "tasks/TODO-064_de.md"
    click TODO_065 "tasks/TODO-065_de.md"
    click TODO_066 "tasks/TODO-066_de.md"
    click TODO_067 "tasks/TODO-067_de.md"
    click TODO_068 "tasks/TODO-068_de.md"
    click TODO_069 "tasks/TODO-069_de.md"
    click TODO_113 "tasks/TODO-113_de.md"
    click TODO_225 "tasks/TODO-225_de.md"
    click TODO_390 "tasks/TODO-390_de.md"
    click TODO_407 "tasks/TODO-407_de.md"
    click TODO_408 "tasks/TODO-408_de.md"
    click TODO_421 "tasks/TODO-421_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W21-termine-reconciliation_de.md)
...
flowchart TD
    ...
    TODO_240 --> TODO_244
    TODO_372 --> TODO_374
    click TODO_102 "tasks/TODO-102_de.md"
    click TODO_103 "tasks/TODO-103_de.md"
    click TODO_104 "tasks/TODO-104_de.md"
    click TODO_105 "tasks/TODO-105_de.md"
    click TODO_197 "tasks/TODO-197_de.md"
    click TODO_198 "tasks/TODO-198_de.md"
    click TODO_226 "tasks/TODO-226_de.md"
    click TODO_239 "tasks/TODO-239_de.md"
    click TODO_240 "tasks/TODO-240_de.md"
    click TODO_241 "tasks/TODO-241_de.md"
    click TODO_242 "tasks/TODO-242_de.md"
    click TODO_243 "tasks/TODO-243_de.md"
    click TODO_244 "tasks/TODO-244_de.md"
    click TODO_372 "tasks/TODO-372_de.md"
    click TODO_374 "tasks/TODO-374_de.md"
    click TODO_402 "tasks/TODO-402_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W23-agent-memory_de.md)
...
flowchart TD
    ...
    TODO_112 --> TODO_156
    TODO_156 -.-> TODO_158
    click TODO_110 "tasks/TODO-110_de.md"
    click TODO_111 "tasks/TODO-111_de.md"
    click TODO_112 "tasks/TODO-112_de.md"
    click TODO_156 "tasks/TODO-156_de.md"
    click TODO_158 "tasks/TODO-158_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W27-general-bugfix_de.md)
...
flowchart TD
    ...
    click TODO_397 "tasks/TODO-397_de.md"
    click TODO_468 "tasks/TODO-468_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W29-telli-terminbuchung_de.md)
...
flowchart TD
    ...
    TODO_484 -.-> TODO_485
    TODO_469 -.-> TODO_486
    click TODO_140 "tasks/TODO-140_de.md"
    click TODO_141 "tasks/TODO-141_de.md"
    click TODO_142 "tasks/TODO-142_de.md"
    click TODO_143 "tasks/TODO-143_de.md"
    click TODO_144 "tasks/TODO-144_de.md"
    click TODO_145 "tasks/TODO-145_de.md"
    click TODO_146 "tasks/TODO-146_de.md"
    click TODO_147 "tasks/TODO-147_de.md"
    click TODO_148 "tasks/TODO-148_de.md"
    click TODO_149 "tasks/TODO-149_de.md"
    click TODO_150 "tasks/TODO-150_de.md"
    click TODO_151 "tasks/TODO-151_de.md"
    click TODO_373 "tasks/TODO-373_de.md"
    click TODO_469 "tasks/TODO-469_de.md"
    click TODO_484 "tasks/TODO-484_de.md"
    click TODO_485 "tasks/TODO-485_de.md"
    click TODO_486 "tasks/TODO-486_de.md"
    click TODO_372 "tasks/TODO-372_de.md"
    click TODO_380 "tasks/TODO-380_de.md"
    click TODO_458 "tasks/TODO-458_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W31-transactional-email_de.md)
...
flowchart TD
    ...
    TODO_164 --> TODO_177
    TODO_167 -.-> TODO_355
    click TODO_160 "tasks/TODO-160_de.md"
    click TODO_161 "tasks/TODO-161_de.md"
    click TODO_162 "tasks/TODO-162_de.md"
    click TODO_163 "tasks/TODO-163_de.md"
    click TODO_164 "tasks/TODO-164_de.md"
    click TODO_165 "tasks/TODO-165_de.md"
    click TODO_166 "tasks/TODO-166_de.md"
    click TODO_167 "tasks/TODO-167_de.md"
    click TODO_176 "tasks/TODO-176_de.md"
    click TODO_177 "tasks/TODO-177_de.md"
    click TODO_355 "tasks/TODO-355_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W34-gworkspace-sync-integrity_de.md)
...
flowchart TD
    ...
    TODO_377 --> TODO_379
    TODO_378 --> TODO_379
    click TODO_178 "tasks/TODO-178_de.md"
    click TODO_179 "tasks/TODO-179_de.md"
    click TODO_309 "tasks/TODO-309_de.md"
    click TODO_310 "tasks/TODO-310_de.md"
    click TODO_377 "tasks/TODO-377_de.md"
    click TODO_378 "tasks/TODO-378_de.md"
    click TODO_379 "tasks/TODO-379_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W35-supabase-v2-rbac-onboarding_de.md)
...
flowchart TD
    ...
    click TODO_180 "tasks/TODO-180_de.md"
    click TODO_181 "tasks/TODO-181_de.md"
    click TODO_182 "tasks/TODO-182_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W37-infra-tooling-admin_de.md)
...
flowchart TD
    ...
    TODO_187 -.-> TODO_394
    TODO_187 -.-> TODO_395
    click TODO_187 "tasks/TODO-187_de.md"
    click TODO_188 "tasks/TODO-188_de.md"
    click TODO_189 "tasks/TODO-189_de.md"
    click TODO_194 "tasks/TODO-194_de.md"
    click TODO_195 "tasks/TODO-195_de.md"
    click TODO_196 "tasks/TODO-196_de.md"
    click TODO_245 "tasks/TODO-245_de.md"
    click TODO_247 "tasks/TODO-247_de.md"
    click TODO_362 "tasks/TODO-362_de.md"
    click TODO_368 "tasks/TODO-368_de.md"
    click TODO_392 "tasks/TODO-392_de.md"
    click TODO_393 "tasks/TODO-393_de.md"
    click TODO_394 "tasks/TODO-394_de.md"
    click TODO_395 "tasks/TODO-395_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W39-orbit-green-schema-hardening_de.md)
...
flowchart TD
    ...
    click TODO_204 "tasks/TODO-204_de.md"
    click TODO_205 "tasks/TODO-205_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W40-supabase-public-optimization_de.md)
...
flowchart TD
    ...
    click TODO_206 "tasks/TODO-206_de.md"
    click TODO_207 "tasks/TODO-207_de.md"
    click TODO_208 "tasks/TODO-208_de.md"
    click TODO_209 "tasks/TODO-209_de.md"
    click TODO_210 "tasks/TODO-210_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W49-proposals-working-hours-correctness_de.md)
...
flowchart TD
    ...
    TODO_332 -.-> TODO_333
    TODO_437 -.-> TODO_458
    click TODO_332 "tasks/TODO-332_de.md"
    click TODO_333 "tasks/TODO-333_de.md"
    click TODO_334 "tasks/TODO-334_de.md"
    click TODO_437 "tasks/TODO-437_de.md"
    click TODO_439 "tasks/TODO-439_de.md"
    click TODO_458 "tasks/TODO-458_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
...
[Stream-Datei](streams/W50-customer-feedback_de.md)
...
flowchart TD
    ...
    click TODO_335 "tasks/TODO-335_de.md"
    click TODO_436 "tasks/TODO-436_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W51-analysis-pass-reports_de.md)
...
flowchart TD
    ...
    click TODO_370 "tasks/TODO-370_de.md"
    click TODO_391 "tasks/TODO-391_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W52-clean-consolidate-overdelete-incident_de.md)
...
flowchart TD
    ...
    TODO_433 -.-> TODO_434
    TODO_435 -.-> TODO_443
    click TODO_422 "tasks/TODO-422_de.md"
    click TODO_433 "tasks/TODO-433_de.md"
    click TODO_434 "tasks/TODO-434_de.md"
    click TODO_435 "tasks/TODO-435_de.md"
    click TODO_443 "tasks/TODO-443_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W53-termine-sync-annotation_de.md)
...
flowchart TD
    ...
    TODO_430 -.-> TODO_432
    TODO_442 -.-> TODO_444
    click TODO_424 "tasks/TODO-424_de.md"
    click TODO_425 "tasks/TODO-425_de.md"
    click TODO_426 "tasks/TODO-426_de.md"
    click TODO_427 "tasks/TODO-427_de.md"
    click TODO_428 "tasks/TODO-428_de.md"
    click TODO_429 "tasks/TODO-429_de.md"
    click TODO_430 "tasks/TODO-430_de.md"
    click TODO_431 "tasks/TODO-431_de.md"
    click TODO_432 "tasks/TODO-432_de.md"
    click TODO_438 "tasks/TODO-438_de.md"
    click TODO_441 "tasks/TODO-441_de.md"
    click TODO_442 "tasks/TODO-442_de.md"
    click TODO_444 "tasks/TODO-444_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W54-clean-consolidate-refactor_de.md)
...
flowchart TD
    ...
    TODO_446 --> TODO_451
    TODO_459 -.-> TODO_460
    click TODO_445 "tasks/TODO-445_de.md"
    click TODO_446 "tasks/TODO-446_de.md"
    click TODO_447 "tasks/TODO-447_de.md"
    click TODO_448 "tasks/TODO-448_de.md"
    click TODO_449 "tasks/TODO-449_de.md"
    click TODO_450 "tasks/TODO-450_de.md"
    click TODO_451 "tasks/TODO-451_de.md"
    click TODO_459 "tasks/TODO-459_de.md"
    click TODO_460 "tasks/TODO-460_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
    classDef obsolete fill:#e9ecef,stroke:#868e96,color:#1a1a1a;
...
[Stream-Datei](streams/W57-booking-consolidation-attendees_de.md)
...
flowchart TD
    ...
    TODO_463 --> TODO_466
    TODO_458 -.-> TODO_467
    click TODO_462 "tasks/TODO-462_de.md"
    click TODO_463 "tasks/TODO-463_de.md"
    click TODO_464 "tasks/TODO-464_de.md"
    click TODO_465 "tasks/TODO-465_de.md"
    click TODO_466 "tasks/TODO-466_de.md"
    click TODO_467 "tasks/TODO-467_de.md"
    click TODO_458 "tasks/TODO-458_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
...
[Stream-Datei](streams/W58-integration-test-hardening_de.md)
...
flowchart TD
    ...
    TODO_464 -.-> TODO_481
    TODO_482 -.-> TODO_483
    click TODO_470 "tasks/TODO-470_de.md"
    click TODO_471 "tasks/TODO-471_de.md"
    click TODO_472 "tasks/TODO-472_de.md"
    click TODO_473 "tasks/TODO-473_de.md"
    click TODO_474 "tasks/TODO-474_de.md"
    click TODO_475 "tasks/TODO-475_de.md"
    click TODO_476 "tasks/TODO-476_de.md"
    click TODO_477 "tasks/TODO-477_de.md"
    click TODO_478 "tasks/TODO-478_de.md"
    click TODO_479 "tasks/TODO-479_de.md"
    click TODO_480 "tasks/TODO-480_de.md"
    click TODO_481 "tasks/TODO-481_de.md"
    click TODO_482 "tasks/TODO-482_de.md"
    click TODO_483 "tasks/TODO-483_de.md"
    click TODO_464 "tasks/TODO-464_de.md"
    classDef open fill:#ffe3e3,stroke:#c92a2a,color:#1a1a1a;
    classDef wip fill:#fff3bf,stroke:#e8590c,color:#1a1a1a;
    classDef done fill:#d3f9d8,stroke:#2b8a3e,color:#1a1a1a;
...
### W36 — Closer/Setter-Dashboard-Reconciliation (neuer Task + Verengung)
- 🔴 [TODO-218](tasks/TODO-218.md) erstellt (P1, Abhängigkeit `→TODO-199`) — Lead-`source` + Booker-Lineage auf dem Dashboard-KPI-Breakdown-Endpoint ausspielen (`QualityFunnelBreakdownRecord`, `GET /kpi/performance/breakdown`); entblockt **ORBIT-FE-039** B2 (No-Show nach Lead-Quelle). [TODO-183](tasks/TODO-183.md) **verengt** — die pro-Setter-/pro-Closer-Leaderboard- & Count-Endpoints, die er ursprünglich umfasste, sind bereits geliefert (W15/W18/W19: `closer-performance`, `setter-performance`, `closer-capacity`), daher auf die residuale Drill-down-Audit-Log-Lineage-Oberfläche verengt (wer gebucht hat, welcher Quell-Kalender) mit harter Abhängigkeit `→TODO-218`. JL-Roadmap-vs-Code-Audit (2026-06-10); das FE-Gegenstück ist ORBIT-FE-047 (Closer-Kapazität-Live-Anbindung) + ORBIT-FE-039-Aktualisierung.

### W15 — Dashboard-Endpoints (erweitert: Executive Overview)
- 🔴 [TODO-214](tasks/TODO-214.md) · [TODO-215](tasks/TODO-215.md) · [TODO-216](tasks/TODO-216.md) · [TODO-217](tasks/TODO-217.md) — OFFEN. Erweitert den bestehenden Stream **W15 — Dashboard-Endpoints** um die Backend-Endpoints, die der neue Frontend-Stream Executive Overview (**ORBIT-FE W12**) konsumiert, OHNE die Headline-Aggregations-Task TODO-075 (wip) zu duplizieren: Period-over-Period- + Vorjahres-Vergleich (214 → ORBIT-FE-041/045), company-weiter 8-stufiger Conversion-Funnel (215 · P1 → ORBIT-FE-042), BE-seitiger Weighted-Pipeline-Wert (216 → ORBIT-FE-043), Termine/Tag nach Buchungsquelle (217 → ORBIT-FE-044). Alles auf v2, wiederverwendet `resolve_range`, `WhitelistService`, `kpi_daily_aggregates` und die Supabase-Quality-Funnel-Funktion auf Unternehmensebene. Zähler: +4 Tasks (214–217); P1 offen +1 (215), P2 offen +3 (214, 216, 217); Bucket Architecture +4. (Ursprünglich als 211–214 entworfen; wegen einer Push-Race-ID-Kollision mit origins unrelated TODO-211–213 auf 214–217 umnummeriert.) W15 bleibt 🔴 Offen.

## Status-Update — 2026-06-06

### W28 — Issue-Tracking v2 / Roadmap-as-Data (neuer Stream)
- 🔴 [TODO-131](tasks/TODO-131.md) · [TODO-132](tasks/TODO-132.md) · [TODO-133](tasks/TODO-133.md) · [TODO-134](tasks/TODO-134.md) · [TODO-135](tasks/TODO-135.md) · [TODO-136](tasks/TODO-136.md) — OFFEN. Neuer Stream **W28 — Issue-Tracking v2 (Roadmap-as-Data)**, aus einer Nutzer-Direktive (2026-06-06) nach einer Recherche- + Design-Session (Root-Cause + 4-Agenten-Web/Local-Sweep, freigegebener Plan `roadmap-as-data`, Option A). Ersetzt die handgepflegte Roadmap durch **eine Datei pro Task** (`tasks/TODO-NNN.md`, TOML-Frontmatter) als einzige Quelle der Wahrheit und ein **generiertes** `TODO.md`/`TODO_de.md`; Claims bearbeiten genau eine Datei, und ein eigener Git-Merge-Driver rendert das Dashboard bei Konflikt neu — das beseitigt die Konfliktklasse, die 41 Reconcile/Repair-Commits und die W24→W25-Push-Race-Umnummerierung erzeugte. Liefert: `roadmap_lib`-Parser (131), `render_roadmap`-Generator (132), `check_roadmap` + CI/pre-commit/Make-Verdrahtung (133), den Merge-Driver + `install-hooks.sh` (134), die One-Shot-Migration mit Round-Trip-Verifikation (135) und das AGENTS.md-Regel-Rewrite + ADR + Docs-Cutover (136). Alle Rule-6-Mechaniken erhalten. Zähler: Gesamt 130→136, OFFEN 68→74; P1 offen 30→36 (131..136); Buckets Architecture 35→37 (131, 132), Prevention 17→19 (133, 134), Migration 4→5 (135), Docs 15→16 (136). W28 → 🔴 Offen (0/6).

## Status-Update — 2026-06-05

### W24 — SQL-Injection-Härtung (neuer Stream)
- 🔴 [TODO-114](tasks/TODO-114.md) · [TODO-115](tasks/TODO-115.md) · [TODO-116](tasks/TODO-116.md) · [TODO-117](tasks/TODO-117.md) — OPEN. Neuer Stream **W24 — SQL-Injection-Härtung**, abgeleitet aus einem read-only SQLi-Audit vom 2026-06-05 (3-Agenten-Sweep über ~66 `text()`-Stellen + direkte file:line-Verifizierung). Der Code ist ORM-first und weitgehend sicher, aber die Sicherheit ist **undokumentiert** (kein ADR), **ungeschützt** (kein Linter), **ungetestet** (null SQLi-Regressionstests), und mehrere rohe `text()`-Stellen sind nur durch FastAPI-Int-Coercion oder dadurch sicher, dass ein interpolierter Wert eine Konstante-aus-Gewohnheit ist. W24 liefert: Strategie + ADR-014 (114), den Sweep + Fixes der fragilen Interpolationen inkl. der ungetrackten `[location_service.py:181](app/services/v4/orbit/location_service.py#L181)`-LIMIT/OFFSET-Senke (115), einen `check_no_raw_sql_interpolation`-Pre-Commit-/CI-Guard (116) und eine echte-Postgres-SQLi-Regressions-Suite (117). Orthogonal zu **W7** (dessen TODO-024 die eine *bekannte* `sales.py:77`-Senke behebt — W24 querverweist, dupliziert nicht). Zähler: Gesamt 113→117, offen 63→67, Security-Bucket 10→12, Prevention-Bucket 14→16, P1 offen 29→31, P2 offen 26→28.

### W25 — Kundentermin-Duplikaterkennung (neuer Stream)
- 🔴 [TODO-118](tasks/TODO-118.md) · [TODO-119](tasks/TODO-119.md) · [TODO-120](tasks/TODO-120.md) · [TODO-121](tasks/TODO-121.md) · [TODO-122](tasks/TODO-122.md) — OFFEN. Neuer Stream aus einer Nutzeranweisung (2026-06-05), **umnummeriert W24 → W25 / TODO-114..118 → TODO-118..122** nach einer Push-Race-Kollision mit dem zuerst gelandeten SQL-Injection-Härtungs-W24. Erkenne doppelte `CUSTOMER_VISIT`-`cached_events` per **Fuzzy-`customer_name`-Match** + **harte Indikatoren** (gleiche Adresse UND/ODER gleiche Start+End-Zeit) → 0–100 **Confidence**; bei **≥ 90 %** automatisch den Duplikat-Eintrag **soft-löschen** (`is_deleted=True, deleted_at=now()`) und den **Google-Kalender-Blocker** über den stillen, idempotenten Dedup-Pfad **löschen** (`sendUpdates=none`), sodass der **Teilnehmer NICHT benachrichtigt** wird. Grundlage: Conflict-Endpoint nur Overlap (`ai_optimize_service.py:392`, `termine.py:500`), `cleanup_service`-Soft-Delete + `_is_same_logical_meeting`, Travel-Blocker-Dedup-Still-Delete (`google_calendar_dedup_batch_delete.py:53`), latenter benachrichtigender Delete-Bug (`calendar_sync_service.py:9469/9820`). Zähler: Gesamt 117→122, OFFEN 67→72; P1 31→34 (118, 120, 121), P2 28→30 (119, 122); Buckets Correctness 19→21, Architecture 31→32, Stability 7→8, Docs 12→13. W25 → 🔴 Offen (0/5).

### W26 — Window-Anchoring-Strategie der Empfehlungs-Engine (neuer Stream)
- 🔴 [TODO-123](tasks/TODO-123.md) · [TODO-124](tasks/TODO-124.md) · [TODO-125](tasks/TODO-125.md) · [TODO-126](tasks/TODO-126.md) · [TODO-127](tasks/TODO-127.md) · [TODO-128](tasks/TODO-128.md) — OFFEN. Neuer Stream **W26 — Window-Anchoring-Strategie der Empfehlungs-Engine**, aus einer Nutzer-Direktive (2026-06-05), quellen-verifiziert durch einen 4-Agenten-Read-only-Sweep. Die Empfehlungs-Engine (`SalesOptimizer`/`HILProposalService`) verankert das vorschlagbare Tagesfenster am Erste-Termin-Start / Letzter-Termin-Ende des Reps (`optimizer.py:1621-1639`, gespeist aus `SalesWorkingHour.first_appointment_time`/`.last_appointment_time` via `hil_proposal_service.py:386-409`). Der Vertrieb braucht zusätzlich einen **Fahrtzeit**-Anker (Losfahren / Ankunft zu Hause), um Aufsteh- + Fahrtzeit zu planen; die Spalten existieren bereits, sind aber **dormant** — `orbit_green.sales_working_hours.first_travel_start` („erste-fahrt-start") / `.last_travel_end` („ankunft-zu-hause") (TIME, nullable; Migration `de03c50d8250`; ORM `sales_working_hour.py:71-81`) — nur vom Working-Hours-CRUD-Pfad gelesen, nie vom Optimizer. W26 führt ein **Flag `ORBIT_RECOMMENDATION_WINDOW_ANCHOR` (appointment | travel, Default `appointment`) ein, um zwischen beiden Logiken umzuschalten, ohne die aktuelle zu brechen**, über ein **Strategy-Pattern**, das das bestehende `MeritStrategy` (`strategies.py`) und die Flag-gewählte-Implementierung-Präzedenz `ORBIT_TRAVEL_TIME_SOURCE`/`TravelTimeEstimationService` (`config.py:964-973`, `travel_time_estimation_service.py:37-53`) spiegelt. Entscheidung festgehalten in **ADR-015** (TODO-123; ADR-014 ist vom offenen W24 reserviert). NULL-Fahrt-Spalten fallen pro Wochentag auf das Terminfenster zurück. Zähler: Gesamt 122→128, OFFEN 72→78, P1 offen 34→39 (123,124,125,126,127), P2 offen 30→31 (128); Buckets Architecture 32→35 (124,125,126), Docs 13→15 (123,128), Prevention 16→17 (127). W26 → 🔴 Offen (0/6).

### W27 — Allgemeiner Bugfix (neuer Stream)
- 🔴 [TODO-129](tasks/TODO-129.md) — OFFEN. Neuer **Sammel-Bugfix-Stream W27** aus dem Produktions-Fehlerlog `2026-06-05 10:16:15 - ERROR - Failed to book proposal` + Nutzer-Direktive (2026-06-05), root-caused durch einen verifizierten 4-Agenten-Read-only-Sweep. Das `cached_events`-UPDATE des Buchungs-Flows (Google-Sync-Schritt) **feuert den AFTER-Trigger** `orbit_green.sync_cached_event_to_termine_after_upsert()`, dessen `INSERT INTO public.termine … ON CONFLICT (google_event_id, mitarbeiter_id)` nach Migration `6de3d397cecb` (2026-06-04) zu keiner Constraint mehr passt — diese tauschte die 2-spaltige Unique gegen die **3-spaltige** `termine_google_event_mitarbeiter_source_unique (…, calendar_source)` → `asyncpg.InvalidColumnReferenceError` → Session vergiftet → `PendingRollbackError` beim `commit()` (`hil_proposal_service.py:1357`). Akute Ursache = **Deploy-Lag** (Trigger-Realign-Fix `03e676141162` ist bereits auf `main`, Vorfahre von Head `f1c2d3e4b5a6`, war aber auf der fehlerhaften Umgebung nicht angewendet). Rest-Codebugs am HEAD: veraltete 2-spaltige Raw-SQL-Upserts `termine_repository.py:383,416` und die Session-Vergiftung durch verschluckte Exception in `hil_proposal_service.py:1351-1355`. Notion-Epic **[EPIC · W27]** (Subtask TODO-129). Zähler: Gesamt 128→129, OFFEN 74→75; P0 offen 3→4 (129); Bucket Correctness 21→22. W27 → 🔴 Offen (0/1).
- 🔴 [TODO-130](tasks/TODO-130.md) — OFFEN. Aus einem **zweiten** Produktionsfehler `2026-06-05 11:00:46 - ERROR - Failed to update status` (`update_event_status` → `cached_event_repository.update_status` → `dual_write` → Flush von `UPDATE cached_events SET termin_status='Stattgefunden'`). Gleicher Trigger wie TODO-129, aber root-caused (3-Agenten-Read-only-Sweep + direktes Lesen von `03e676141162:74-199`) auf eine **unvollständige Fix-Migration**: `03e676141162` korrigierte nur den Fallback-Zweig ohne Meta-Version (`:188`, 3-spaltig) und ließ den `IF FOUND`-/Meta-Version-Zweig (`:134`) bei 2-spaltig `ON CONFLICT (google_event_id, mitarbeiter_id)`, sodass jedes **klassifizierte** Event (mit einer `cached_event_meta_versions`-Zeile) **sogar am Head** scheitert — das **korrigiert die reine Deploy-Lag-Darstellung von TODO-129**. Blast-Radius: jeder cached_events-Write (Status/Place-Type/Klassifikation/Lead-Remap/Soft-Delete/Buchung) auf einem Meta-Version-Event → effektiver Ausfall der cached_events-Mutation. Fix = eine neue Vorwärts-Migration, die alle Trigger-`ON CONFLICT`-Zweige auf das 3-spaltige Ziel ausrichtet. Notion-Subtask unter [EPIC · W27]. Zähler: Gesamt 129→130, OFFEN 75→76; P0 offen 4→5 (130); Bucket Correctness 22→23. W27 → 🔴 Offen (0/2).

## Status-Update — 2026-06-04

### W22 — Onboarding-Readiness für Vertriebsmitarbeiter (neuer Stream)
- ✅ [TODO-106](tasks/TODO-106.md) — DONE. RCA + Operator-Runbook für den Onboarding-Vorfall vom 2026-06-04: der neue Galvanek-Rep `i.bollmann@galvanek-bau.de` hatte ein SalesOS-Konto, IAM-Rolle `orbit_verkaeufer` und eine `Aktiv`-`public.mitarbeiter`-Zeile (alle **live gegen Prod-Supabase bestätigt**), dennoch synchronisierten Profil/Leads/Kalender nicht. Einzige Ursache: das Orbit-seitige `orbit_green.sales.is_whitelisted`-Tor — laut ADR-001 bewusst manuell, vom Profil-Sync nicht gesetzt — wurde nie umgelegt, was gleichzeitig Leads verbirgt (`lead_repository.py:1002,1167`) und den Kalender-Webhook blockiert (`orbit_webhook_startup.py:147`). Er ist der erste Rep, der nach der Verschiebung der Whitelist von einer Code-Konstante (`c2892c29`) auf die DB-Spalte (`8d2e231a`, TODO-006) onboardet wurde, und kein Runbook hielt den neuen manuellen Schritt fest. Geliefert: `docs/findings/BOLLMANN_GALVANEK_ONBOARDING_RCA.md` + `onboarding/salesperson_onboarding_checklist.md` (+ `_de`-Zwillinge).
- 🔴 [TODO-107](tasks/TODO-107.md) · [TODO-108](tasks/TODO-108.md) · [TODO-109](tasks/TODO-109.md) — OPEN (unabhängig, Fan-out): ein read-only Onboarding-Readiness-Prüfwerkzeug (einmaliger SalesOS→Orbit-Aktivierungsstatus für eine E-Mail); die KPI-Aggregation `is_whitelisted` statt der hartkodierten pg_cron-Liste lesen lassen (schließt die Neuzugangs-KPI-Lücke; soft-verlinkt TODO-016); und Startup-Observability, die einen `Aktiv`-mitarbeiter ohne whitelistete `sales`-Zeile meldet. W22 → 🔴 Offen (1/4).

### W21 — Termine prod ↔ Supabase Rekonziliation (neuer Stream)
- ✅ [TODO-101](tasks/TODO-101.md) — DONE (`0288f0a7`, gemergt via MR !1941). Neuer Stream W21: Internal-Auth-Wartungs-Endpoint rekonziliert Supabase `public.termine` aus `orbit_green.cached_events` (upsert-only, monatsweise gechunkt) + Fingerprint-Konsistenzcheck, entstanden aus der RCA vom 2026-06-04 (Supabase fehlen ~72k `ORBIT-PROD*`-Zeilen gegenüber dem RDS). Wiederverwendet `SupabaseTermineSyncService` + das W13-Internal-Auth-Sync-Trigger-Muster. Tests: 15 Unit + 3 testcontainers Integration (skip ohne Docker).

### W14 — Performance-Dashboard Nachvollziehbarkeit & Vertrauen
- ✅ [TODO-068](tasks/TODO-068.md) — Wiederverwendbarer `assert_funnel_monotonicity`-Guard in `utils.py`, an `validate_quality_funnel` angebunden; Regressionstests `TestMonotonicityGuard` (`cf01d76`)

### W19 — Closer Performance · Kapazitäts-Endpunkt
- ✅ [TODO-094](tasks/TODO-094.md) · [TODO-095](tasks/TODO-095.md) · [TODO-096](tasks/TODO-096.md) — Stream W19 geschlossen (`0e9ae40`, gemergt via `thuan_Dev` → main). `KpiCloserCapacityService` + `GET /internal/api/v2/orbit/kpi/closer-capacity` mit Abwesenheits-/Arbeitstags-Proration und `week_offset` (−1/0/1).

### W21 — Rekonziliations-Observability & -Automation (4 neue Tasks)
- 🔴 [TODO-102](tasks/TODO-102.md) · [TODO-103](tasks/TODO-103.md) · [TODO-104](tasks/TODO-104.md) · [TODO-105](tasks/TODO-105.md) — OPEN. TODO-101 operationalisieren + beobachten: ein täglicher `stage: schedule`-CI-Job, der den Reconcile-Endpoint mit `verify_only=false` ausführt (nächtliche **Auto-Heilung**, Entscheidung 2026-06-04); **OTel**-Metriken + Span auf dem Reconcile-Service für eine Grafana-Sicht; eine CI-Job-Drift-**E-Mail**-Warnung, wenn `rows_missing_after > 0` (vom Job geliefert, nicht von Grafana/Alertmanager — Entscheidung 2026-06-04); und ein view-only-**Grafana**-Drift-Dashboard. Drift-Signal = der Fingerprint-Konsistenzcheck des Endpoints (das portierte `compare_termine_orbit_prod_prod_vs_supabase.sql`). W21 → 🔴 Offen (1/5).

## Status-Update — 2026-06-03

### W12 — Klassifikations-Workflow
- ✅ [TODO-045](tasks/TODO-045.md) — LLM-Batch-Parser-Bug behoben (`dcefddbf`)

### W13 — Sales-Verfügbarkeit Re-Architektur
- ✅ [TODO-051](tasks/TODO-051.md) — ADR abgeschlossen (`c90f7fcf`)

### W14 — Performance-Dashboard Nachvollziehbarkeit & Vertrauen
- ✅ [TODO-062](tasks/TODO-062.md) — Aufgeblähte „133 unterschriebene THC“-Zählung behoben durch Umstellung auf Distinct-Lead-Granularität in Python und SQL (`dd813ca3`)
- ✅ [TODO-063](tasks/TODO-063.md) — No-Show-Prozentberechnung behoben (`42ec02b5`)
- ✅ [TODO-065](tasks/TODO-065.md) — KPI-Lineage-Felder ergänzt (`10fd5ee9`)

### W15 — Performance-Dashboard Endpunkt-Abdeckung
- ✅ [TODO-071](tasks/TODO-071.md) — ADR-009 Rollen-/Team-Modell abgeschlossen (`806b49b5`)
- ✅ [TODO-072](tasks/TODO-072.md) — Setter-Aggregations-Service abgeschlossen (`806b49b5`)
- 🟡 [TODO-073](tasks/TODO-073.md) — Setter-Leaderboard-Endpoint
  - Endpoint implementiert
  - Summenzeile fehlt
  - Drill-Down-Handle fehlt
- 🟡 [TODO-074](tasks/TODO-074.md) — Closer-Leaderboard-Endpoint
  - Endpoint implementiert
  - Summenzeile fehlt
  - Drill-Down-Handle fehlt
- ✅ [TODO-077](tasks/TODO-077.md) — Pipeline-Tab-Endpoint abgeschlossen (50ddcfa7)
- ✅ [TODO-100](tasks/TODO-100.md) — Closer-Demand-Endpoint abgeschlossen (`WIP`)

### W16 — PartnerService-Lead-Duplikat-Abschaltung & Deduplizierung
- ✅ [TODO-084](tasks/TODO-084.md) — Abgeschlossen (`06b5fcfa`)
  - Hinweis: OTel-Warning-Literal nennt noch die Legacy-ID `TODO-072`

### W17–W20 — Closer-Performance-Dashboard-Backend (zusammengeführt 2026-06-03)
- 🔀 Die eigenständige Roadmap `orbit-galvanek/docs/closer-performance-backend-roadmap.md` (Quelle S1–S4 / 11 Tasks) als vier neue Streams in diese Roadmap zusammengeführt, auf unsere IDs umnummeriert und gegen den Live-Backend-Code + das `orbit_green`-Schema verifiziert (3-Agenten-Sweep):
  - [W17](streams/W17-closer-schema_de.md) — Schema-Grundlagen: 🟡 [TODO-089](tasks/TODO-089.md) (Self-Booking-Lineage), 🔴 [TODO-090](tasks/TODO-090.md) (abfragbarer Funnel)
  - [W18](streams/W18-closer-leaderboard_de.md) — Leaderboard-Endpunkt: 🔴 [TODO-091](tasks/TODO-091.md) (Closer-Row erweitern — **hängt von W15 TODO-074 ab**), 🔴 [TODO-092](tasks/TODO-092.md) (Netto-Umsatz-Semantik — blockierende Entscheidung), 🔴 [TODO-093](tasks/TODO-093.md) (Response-Envelope)
  - [W19](streams/W19-closer-capacity_de.md) — Kapazitäts-Endpunkt: ✅ TODO-094, 095, 096 (DONE `0e9ae40`)
  - [W20](streams/W20-closer-tests-contract_de.md) — Tests & FE-Vertrag: 🔴 TODO-097, 🔴 TODO-098, 🔴 TODO-099
- Referenz-Zeilendrift beim Import korrigiert: Closer-Performance-Endpunkt `app/api/v2/orbit/kpi.py:130-216` (Quelle nannte `:194-282`); `CloserPerformanceRow` bei `app/schemas/orbit/kpi.py:408-419` (Quelle nannte `:353`). Beim Import verifiziert: **keine AG-Leg-Funnel-Spalten**; v2-`closer-capacity` mit W19 gelandet (`0e9ae40`).

### Korrekturen & Abgleich
- Ungültige/veraltete Commit-Hashes korrigiert:
...
### Offene Verifizierungs-Befunde
- 🟡 [TODO-070](tasks/TODO-070.md) bleibt in Arbeit
  - Commit `f3d31b7d` enthält nur Dokumentationsänderungen
  - IDOR-artiger `salesperson_id`-Filter ist weiterhin aktiv
  - 404-statt-403-Verhalten ist weiterhin aktiv
  - Betroffene Dateien:
...
### Bekannte verbleibende Vorbehalte
- [TODO-063](tasks/TODO-063.md): Nenner bleibt `termin_count` (im aktuellen Scope akzeptiert)
- [TODO-072](tasks/TODO-072.md): fehlender Doppelzähl-Abgleichstest gegen [TODO-066](tasks/TODO-066.md)
- [TODO-051](tasks/TODO-051.md): ADR-Platzhalter `ADR-[NUMBER]` **behoben** — im ADR-Nummerierungs-Audit 2026-06-06 als ADR-017 nummeriert
- [TODO-084](tasks/TODO-084.md): OTel-Warning-Literal nennt noch die vor-umnummerierte ID `TODO-072`

---

## 🌊 Task-Streams — unabhängige Arbeitsstränge

Jeder Stream `WNN` ist ein unabhängiger Arbeitsstrang (eigene `streams/WNN-*.md` mit Ziel, Status & einer
live Top-Down-Abhängigkeitskarte). Die maßgeblichen, **immer-aktuellen** Sichten werden oben und pro
Stream generiert — diese Sektion trägt keine handgemalte globale Karte mehr:

- **Live-Status auf einen Blick:** die **Stream-Zusammenfassung** (oben generiert, nach Priorität
  sortiert) und die **Offene / Geschlossene Streams — Tasks**-Tabellen.
- **Per-Stream-Abhängigkeitskarten:** jede `streams/WNN-*.md` rendert ihre eigene `flowchart TD`
  (Top-Down) Status- & Abhängigkeitskarte, regeneriert von `make roadmap`.
- **Prioritätssortierte offene Streams:** `uv run asol-roadmap-streams` (in diesem Repo: `make streams`).

> 🗑️ Die früheren handgeschriebenen globalen Stream- / Dependency-`flowchart LR`-Karten wurden am
> 2026-06-18 **entfernt** — sie waren veraltet (zeigten noch die deprecate W1–W6-Audit-Ära), wurden nie
> von `make roadmap` regeneriert (ein Verbatim-Include, kein generiertes Output) und nutzten
> horizontales `LR` entgegen der Vertikal-Mermaid-Regel. Eine self-updating, Top-Down globale
> Stream-Übersicht ist als Renderer-Folgeaufgabe getrackt (asol-issue-tracking, W37).
